...
function loadScript() {
  ...
  console.log("target_element_id", targetElement);
  if (!targetElement) {
...
function setOverlay(widthViewport, heigthViewport, widthTarget, heightTarget, xTarget, yTarget, background_opacity) {
  overlay.innerHTML = `
      <svg
