...
function setPopover(targetElement, message_title, message_body, image_url) {
  ...
  popover.style = `position: absolute; top: ${t.yTarget}px; left: ${xTargetInLayout}px; flex: auto; flex-direction: column; max-height: 250px; min-width: 200px; max-width: 250px; padding: 15px; font-family: Arial !important; border: 1px !important; margin: 5px; border-radius: 5% !important; background: white !important; color: black !important; box-shadow: 0 1px 10px #0006 !important; z-index: 1000000; overflow: clip !important; overflow-wrap: break-word !important; word-break: break-all !important;`;
  popoverHeader.style = "margin-bottom: 10px;";
  popoverDescription.style = "margin-bottom: 10px;";
  popoverFooter.style =
